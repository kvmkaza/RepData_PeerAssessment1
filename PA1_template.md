...
```r
knitr::kable(actMeanMedian, caption = "Mean and Median of the total number of steps taken per day")
```
...
```r
knitr::kable(actMeanMedianImputed, caption="Mean/Median Step count per each day after imputation")
```



Table: Mean/Median Step count per each day after imputation
